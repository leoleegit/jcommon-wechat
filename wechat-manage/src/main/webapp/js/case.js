...
jiaoka.wechat_log_search = function(openid,type,from,to,next,number){
...
jiaoka.case_search = function(status,phone_number,nickname,addr,from,to,next,number){
