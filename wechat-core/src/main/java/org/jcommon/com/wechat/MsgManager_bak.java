...
class MsgManager_bak extends ResponseHandler{
    private Logger logger = Logger.getLogger(this.getClass());
    
    private WechatSession session;
    private App app;
    
    public MsgManager_bak(WechatSession session){
    ...
    public HttpRequest getMsgRequest(RequestCallback callback, OutMessage msg){
    	...
    	HttpRequest request = RequestFactory.msgReqeust(callback, app.getAccess_token(), msg.toJson());
    	return request;
    }
